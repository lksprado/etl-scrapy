...
class MercadolivreSpider(scrapy.Spider):
    ...
    start_urls = ["https://lista.mercadolivre.com.br/barco-decorativo"]
    page_count = 1
    max_pages = 15
    ...
    def parse(self, response):
        ...
        for product in products:
            ...
            yield {
                ...
                'reviews_amount': product.css('span.ui-seach-reviews__amount::text').get()
            }

# GERAR OS ARQUIVOS NO TERMINAL
